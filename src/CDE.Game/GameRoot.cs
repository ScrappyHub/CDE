...
{
    // CDE_KERNEL_MENU_TOGGLE_V1
    private KeyboardState _kernelMenuPrev;
    ...
    {
        // CDE_KERNEL_MENU_TOGGLE_V1
        var __kmNow = Keyboard.GetState();
        if (__kmNow.IsKeyDown(Keys.Escape) && !_kernelMenuPrev.IsKeyDown(Keys.Escape))
        {
            global::CDE.Runtime.Engine.KernelOverlayState.MenuOpen = !global::CDE.Runtime.Engine.KernelOverlayState.MenuOpen;
        }
        _kernelMenuPrev = __kmNow;
